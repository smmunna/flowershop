    ...
    <form action="" method="POST">
        ...
        <div class="flex">
            ...
            <div class="inputBox">
                ...
                <input type="text" name="flat" placeholder="e.g. home  no.">
            </div>
            <div class="inputBox">
                <span>address line 02 :</span>
                <input type="text" name="street" placeholder="e.g.  road no">
            </div>
            <div class="inputBox">
                <span>upazilla :</span>
                <input type="text" name="city" placeholder="e.g. bogura sadar">
            </div>
            <div class="inputBox">
                <span>zilla :</span>
                <input type="text" name="state" placeholder="e.g. bogura">
            </div>
            <div class="inputBox">
                <span>country :</span>
            ...
            <div class="inputBox">
                <span>post code :</span>
                <input type="number" min="0" name="pin_code" placeholder="e.g. 5800">
            </div>
        </div>
