...
if(isset($_POST['update_product'])){
   ...
   $status = mysqli_real_escape_string($conn, $_POST['status']);  //Added this

   // Modified Here: status = '$status'
...
<form action="" method="post" enctype="multipart/form-data">
   ...
   <div style="padding: 12px; border:2px solid black; width:100%;">
   
   <!-- THe select Box hasbeen added -->
   <select name="status">
